...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                  <a href="#" class="btn btn-primary" onclick="ShowModalAddItem('{{ $job->id }}');"><i class="fa fa-plus"></i> Add New Item</a>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-12">
            <div class="card" id="div_card_auth_not_sign" @php if($auth->signature != '') echo 'hidden'; @endphp>
            ...
            <div class="card" id="div_card_auth_sign" @php if($auth->signature == '') echo 'hidden'; @endphp>
                ...
                <div class="card-body bg-info text-white">
                  ...
                  A signature was found for the authorizations requested, and was signed by {{ $customer->name }} on {{ \Carbon\Carbon::parse($auth->sign_on)->format('m/d/Y h:i a') }}
                </div>
                <br>
