...
$content = null;
if ($quote->type->name == 'Full Kitchen' || $quote->type->name == 'Cabinet Small Job')
{
...
*/
if ($quote->type->name == 'Cabinet and Install')
{
...
if ($quote->final)
{
    if (Faq::whereQuoteTypeId($quote->quote_type_id)->whereActive(true)->count() > 0)
    {
