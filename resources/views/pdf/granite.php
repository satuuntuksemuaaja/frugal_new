...
$data .= "<img src='".public_path()."/checkbox.png' style='padding:5px'> <b>Slab will be chosen by customer</b> :
...
$data .= "<img src='".public_path()."/checkbox.png' style='padding:5px'> <b>Customer declines option to select slab and understands that granite is a natural stone and that color varies: </b>
...
<br/>";
$data .= "
	<img src='".public_path()."/checkbox.png' style='padding:5px'>
...
<br/>
<img src='".public_path()."/checkbox.png' style='padding:5px'> 		If counters go over the allotted amount, then Frugal Kitchens is no longer able to continue until all change orders have been
