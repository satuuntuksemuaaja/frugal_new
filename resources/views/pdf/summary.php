...
$obj = \FK3\vl\quotes\QuoteGeneratorNew::getQuoteObject($quote);
$data = "<style>
body {
font-family: 'Verdana';
                font-size:14px;
...
<tr>
    <td>Payment Schedule</td> <td align='center'>" . str_replace("<br/><br/>", "<br/>", \FK3\vl\quotes\QuoteGeneratorNew::financing($quote, $obj, false, true)) . "</td>
</tr>
