...
if (isset($meta['quote_knobs']))
{
    foreach ($meta['quote_knobs'] AS $key => $val)
    {
        ...
        $hardware .= "<tr>";
        $hardware .= "<td align='center'>$qty x " . Hardware::find($key)->sku . "{$location}</td>";
		$hardware .= "<td align='center'>Knob</td>";
		$hardware .= "<td align='center'>" . @$meta['quote_knobs_location'][$key] . "</td>";
        $hardware .= "</tr>";
    }
}
...
if (isset($meta['quote_pulls']))
{
    foreach ($meta['quote_pulls'] AS $key => $val)
    {
        ...
        $hardware .= "<tr>";
        $hardware .= "<td align='center'>$qty x " . Hardware::find($key)->sku . " $location</td>";		
		$hardware .= "<td align='center'>Pull</td>";
		$hardware .= "<td align='center'>" . @$meta['quote_pulls_location'][$key] . "</td>";
        $hardware .= "</tr>";
    }
}
$hardware .= "</table>";
