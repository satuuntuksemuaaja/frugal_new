...
class PurchaseController extends Controller
{
    ...
    static public function overridePO(Quote $quote, QuoteCabinet $cabinet)
    {
        ...
        $cabinetClass = Cabinet::find($cabinet->cabinet_id);
        $po = Po::whereJobId($job->id)->whereVendorId($cabinetClass->vendor_id)->whereType('Cabinets')
        ...
        $po->vendor_id = $cabinetClass->vendor_id;
